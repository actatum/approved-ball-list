...
// Ensure, that USBCServiceMock does implement balls.USBCService.
// If this is not the case, regenerate this file with moq.
var _ balls.USBCService = &USBCServiceMock{}

// USBCServiceMock is a mock implementation of balls.USBCService.
//
//	func TestSomethingThatUsesUSBCService(t *testing.T) {
//
//		// make and configure a mocked balls.USBCService
//		mockedUSBCService := &USBCServiceMock{
//			ListBallsFunc: func(ctx context.Context, brand balls.Brand) ([]balls.Ball, error) {
//				panic("mock out the ListBalls method")
//			},
//		}
//
//		// use mockedUSBCService in code that requires balls.USBCService
...
func (mock *USBCServiceMock) ListBalls(ctx context.Context, brand balls.Brand) ([]balls.Ball, error) {
